...
public class OcpPartnerExceptionTest {
	...
	public void initializeOcpPartnerExceptionTest() {
		assertNotNull(new OcpPartnerException(TEST_KEY, MessageSeverity.ERROR, HttpStatus.BAD_REQUEST));
		assertNotNull(
				new OcpPartnerException(TEST_KEY, MessageSeverity.ERROR, HttpStatus.BAD_REQUEST,
						new Exception()));
	}
