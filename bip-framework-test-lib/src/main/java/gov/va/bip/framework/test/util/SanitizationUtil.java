...
public class SanitizationUtil {
	...
	public static String safeFilename(final String filename) {
		...
		StringBuilder cleanFilename;
		try {
			cleanFilename = new StringBuilder();
			...
			throw new BipTestLibRuntimeException("Unexpected error while removing invalid characters in filename");
		}
	...
	public static String stripXSS(final String value) {
		...
		if (value != null) {
			try {
				...
				throw new BipTestLibRuntimeException( "Unexpected error while removing malicious characters");
			}
		}
		return cleanValue;
	}
