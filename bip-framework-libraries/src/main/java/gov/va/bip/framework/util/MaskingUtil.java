...
/**
 * This code has been unceremonially lifted from a pending apache commons-lang PR on StringUtils,
 * with added methods to suit the purposes of BIP Framework.
 * <p>
 * The static methods in this class allow simple methods with sensible defaults,
 * and more flexible methods for custom masks.
 * <p>
 * See <a
...
public class MaskingUtil {
	...
	public final static char DEFAULT_MASK_CHAR = '*';

	/** The default maximum unmasked characters, if {@code maxUnmasked} is not specified */
	private final static int DEFAULT_MAX_UNMASKED = 4;
	/** The default minimum masked characters, if {@code minMasked} is not specified */
	private final static int DEFAULT_MIN_MASKED = 1;

	/**
	 * Do not instantiate.
	 */
	private MaskingUtil() {
		throw new IllegalAccessError("MaskingUtil is a static class. Do not instantiate it.");
	}
	...
	public static String maskStart(String str) {
		return maskStart(str, DEFAULT_MASK_CHAR, 1, DEFAULT_MAX_UNMASKED);
	}
	...
	public static String maskEnd(String str) {
		return maskEnd(str, DEFAULT_MASK_CHAR, 1, DEFAULT_MAX_UNMASKED);
	}
