...
public class BipMaskRulesTest {
  ...
  public void shouldValidateAllRules() throws Exception {
    ...
    String output = rules.apply("My credit card number is 4111111111111111 and my social security number is 123-12-1234");
    assertThat(output).isEqualTo("My credit card number is XXXXXXXXXXXXXXXX and my social security number is XXXXXXXXXXX");
  }
}